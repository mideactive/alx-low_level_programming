...
[103-fibonacci.c](https://github.com/mideactive/alx-low_level_programming/blob/master/0x02-functions_nested_loops/103-fibonacci.c) : I ceated long int fibonacci array that is to store 50 values. i intialized fibonacci[0] to 1, and  fibonacci[1] to 2. I then looped through, and stored the addition of fibonacci[i - 1] + fibonacchi[i - 2] into fibonachi[i]. i did a check to ensure my program is only adding even number, and that it's less than 4,000,000. The all even numbers is the stored inside the 'sum' variable. The result is printed out.
...
[104-fibonacci.c](https://github.com/mideactive/alx-low_level_programming/blob/master/0x02-functions_nested_loops/104-fibonacci.c) : 
